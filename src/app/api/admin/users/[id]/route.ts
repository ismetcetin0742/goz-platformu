...
export async function PATCH(req: Request, { params }: { params: Promise<{ id: string }> }) {
  try {
    ...
    // Güvenlik: Sadece ADMIN rolüne sahip kullanıcılar işlem yapabilir
    ...
    return NextResponse.json({ error: "Kullanıcı güncellenirken bir sunucu hatası oluştu." }, { status: 500 });
  }
}
